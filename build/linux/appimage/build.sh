...
if [[ "${VSCODE_ARCH}" == "x64" ]]; then
  ...
  # add update's url
  sed -i 's/generate_type2_appimage/generate_type2_appimage -u "gh-releases-zsync|Gabriel-Feang|partitura-code|latest|*.AppImage.zsync"/' pkg2appimage.AppDir/AppRun
