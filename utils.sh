...
APP_NAME="${APP_NAME:-Partitura}"
APP_NAME_LC="$( echo "${APP_NAME}" | awk '{print tolower($0)}' )"
ASSETS_REPOSITORY="${ASSETS_REPOSITORY:-Gabriel-Feang/partitura-code}"
BINARY_NAME="${BINARY_NAME:-partitura}"
GH_REPO_PATH="${GH_REPO_PATH:-Gabriel-Feang/partitura-code}"
ORG_NAME="${ORG_NAME:-Partitura}"
