...
# Getting Started with Partitura

This guide will help you get started with Partitura.
...
Partitura can be installed on Windows, macOS, and Linux. Visit the [download page](https://partitura-ai.com/#install) for installation instructions.

## <a id="first-steps"></a>First Steps

After installing Partitura, here are some first steps to get started:
...
Partitura works just like Visual Studio Code, with a few differences:
...
- Explore the [documentation](https://github.com/Gabriel-Feang/partitura-code/blob/master/docs/index.md) for more details
- Join the [community](https://github.com/Gabriel-Feang/partitura-code/discussions) to ask questions and share tips
- Contribute to the [project](https://github.com/Gabriel-Feang/partitura-code/blob/master/CONTRIBUTING.md) if you're interested
