...
Here is the base script to build Partitura:
...
- Linux: https://github.com/Gabriel-Feang/partitura-code/blob/master/.github/workflows/stable-linux.yml
- macOS: https://github.com/Gabriel-Feang/partitura-code/blob/master/.github/workflows/stable-macos.yml
- Windows: https://github.com/Gabriel-Feang/partitura-code/blob/master/.github/workflows/stable-windows.yml
...
# verify the snap
review-tools.snap-review --allow-classic partitura*.snap
```
...
- open `vscode` directory in a new **Partitura**'s window
- fix all the `*.rej` files
- run `npm run watch`
- run `./script/code.sh` until everything is ok
