...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/Gabriel-Feang/partitura-code-versions/refs/heads/master"

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/Gabriel-Feang/partitura-code-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/Gabriel-Feang/partitura-code/releases"
fi
